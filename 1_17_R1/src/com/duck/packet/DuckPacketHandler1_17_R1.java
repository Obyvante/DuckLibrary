...
public final class DuckPacketHandler1_17_R1 implements DuckPacketHandler {
    ...
    public DuckPacketHandler1_17_R1(@Nonnull Player player) {
        Objects.requireNonNull(player, "player cannot be null!");
        this.id = player.getUniqueId();

        //Add new pipeline named "duck_packet_handler" after "packet_handler".
        this.pipeline = ((CraftPlayer) player).getHandle().b.a.k.pipeline().addBefore("packet_handler", "duck_packet_handler", new ChannelDuplexHandler() {
            @Override
