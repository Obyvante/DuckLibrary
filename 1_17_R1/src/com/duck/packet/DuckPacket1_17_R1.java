...
public class DuckPacket1_17_R1 extends DuckPacket {
    ...
    public DuckPacketHandler createHandler(@Nonnull Player player) {
        ...
        DuckPacketHandler duck_packet_handler = new DuckPacketHandler1_17_R1(player);
    ...
    public void send(@Nonnull Object packet, @Nonnull Player... players) {
        ...
        Arrays.stream(players)
                ...
                .forEach(player -> ((CraftPlayer) player).getHandle().b.sendPacket((Packet<?>) packet));
    }
